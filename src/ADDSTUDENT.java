...
public class ADDSTUDENT extends JDialog {
	...
	public ADDSTUDENT() {
		...
		comboBox.setBounds(220, 179, 200, 20);
		contentPanel.add(comboBox);
		
		JLabel lblNewLabel_5 = new JLabel("Select Course");
		lblNewLabel_5.setBounds(50, 179, 120, 20);
		...
		lblNewLabel_9.setBounds(50, 479, 160, 20);
		contentPanel.add(lblNewLabel_9);
		
		textField_6 = new JTextField();
		textField_6.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		textField_6.setBounds(220, 479, 200, 20);
		...
		lblNewLabel_10.setBounds(50, 509, 120, 20);
		...
		rdbtnNewRadioButton.setBounds(220, 509, 109, 23);
		...
		lblNewLabel_12.setBounds(50, 329, 120, 20);
		contentPanel.add(lblNewLabel_12);
		
		textField_8 = new JTextField();
		textField_8.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		textField_8.setBounds(220, 329, 200, 20);
		...
		lblNewLabel_14.setBounds(50, 209, 120, 20);
		contentPanel.add(lblNewLabel_14);
		
		JComboBox comboBox_2 = new JComboBox();
		comboBox_2.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		comboBox_2.setBounds(220, 209, 200, 20);
		contentPanel.add(comboBox_2);
		
		JLabel lblNewLabel_13 = new JLabel("State ");
		lblNewLabel_13.setForeground(Color.WHITE);
		lblNewLabel_13.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		lblNewLabel_13.setBounds(50, 569, 120, 20);
		...
		btnNewButton.setBounds(140, 637, 89, 23);
		contentPanel.add(btnNewButton);
		
		JButton btnNewButton_1 = new JButton("Cancel");
		btnNewButton_1.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		btnNewButton_1.setFocusable(false);
		btnNewButton_1.setBounds(340, 637, 89, 23);
		contentPanel.add(btnNewButton_1);
		
		JLabel lblNewLabel_16 = new JLabel("New label");
		lblNewLabel_16.setIcon(new ImageIcon(ADDSTUDENT.class.getResource("/IMAGE/images__15_-removebg-preview.png")));
