...
public class FacAtteAdd extends JDialog {
	...
	public static void main(String[] args) {
		try {
			FacAtteAdd dialog = new FacAtteAdd();
	...
	public FacAtteAdd() {
		...
		JLabel lblNewLabel_1 = new JLabel("Facuty Id");
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(day1.getText().isEmpty() || day2.getText().isEmpty() ||Y.getText().isEmpty()||sid.getText().isEmpty()){
					...
					try {
						...
						PreparedStatement pst = connection.prepareStatement("insert into FacultyAtten values(?,?,?,?,?,?,?)");
